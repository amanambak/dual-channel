...
- keep the WebSocket, Sarvam streaming ASR, and browser-extension plumbing stable
...
Move finalized utterance handling into a graph. Keep Sarvam streaming ASR and WebSocket code outside the graph boundary.
...
2. Sarvam streaming ASR produces transcript events
